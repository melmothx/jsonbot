# gozerlib/gozerevent.py
#
#

""" 
    basic event used in jsonbot. supports json dumping and loading plus toxml
    functionality. 
"""
...
from gozerlib.socklib.xmpp.namespace import attributes, subelements
